...
INSERT INTO `widgets` SET `name` = 'Reset OVO DB',`description` = 'Esta acción eliminará todas las tablas de la base de datos, lo cual equivale a resetear el sistema a su estado de origen',`slug` = 'dropdatabase',`public` = 1, `order` = 5,`created_at` = NOW(),`created_by` = 0,`modified_at` = NOW();
...
INSERT INTO `widgets` SET `name` = 'Editor de fuente predeterminada', `description` = 'Permite incorporar fuentes de Google Fonts y establecer la fuente predeterminada.', `slug` = 'fonts', `public` = 1, `order` = 6, `created_at` = NOW(), `created_by` = 0, `modified_at` = NOW();
